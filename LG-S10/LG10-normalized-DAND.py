...
dataframe.columns=['stationID','year','month','day','hour','min','sec','epoch','seq#','AmbientTemp','SurfaceTemp','Radiaiton',
                   'RH','Moisture','watermark','rain','windSpeed','WindDirection']
...
scaled_test_df.to_excel("LG-scaled_test_df_DAND-(r5).xlsx")
